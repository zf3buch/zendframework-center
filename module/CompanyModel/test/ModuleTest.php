...
namespace CompanyModelTest;

use CompanyModel\Module;
...
class ModuleTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testInit()
    {
        ...
        $this->assertTrue(defined('COMPANY_MODEL_MODULE_ROOT'));
        $this->assertEquals(
            $this->moduleRoot, realpath(COMPANY_MODEL_MODULE_ROOT)
        );
    }
