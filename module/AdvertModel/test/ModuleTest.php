...
namespace AdvertModelTest;

use AdvertModel\Module;
...
class ModuleTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testInit()
    {
        ...
        $this->assertTrue(defined('ADVERT_MODEL_MODULE_ROOT'));
        $this->assertEquals(
            $this->moduleRoot, realpath(ADVERT_MODEL_MODULE_ROOT)
        );
    }
