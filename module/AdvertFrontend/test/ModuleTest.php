...
namespace AdvertFrontendTest;

use AdvertFrontend\Module;
...
class ModuleTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testInit()
    {
        ...
        $this->assertTrue(defined('ADVERT_FRONTEND_MODULE_ROOT'));
        $this->assertEquals(
            $this->moduleRoot, realpath(ADVERT_FRONTEND_MODULE_ROOT)
        );
    }
