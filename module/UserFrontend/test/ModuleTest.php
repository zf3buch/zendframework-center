...
namespace UserFrontendTest;

use UserFrontend\Module;
...
class ModuleTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testInit()
    {
        ...
        $this->assertTrue(defined('USER_FRONTEND_MODULE_ROOT'));
        $this->assertEquals(
            $this->moduleRoot, realpath(USER_FRONTEND_MODULE_ROOT)
        );
    }
